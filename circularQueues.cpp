...
class Queues {
    ...
    void remove() {
        ...
        if (FRONT == REAR) {
            ...
            // jika elemen yang dihapus beraa diposisi terakhir array, kembali
            if (FRONT == max - 1)
                FRONT = 0;
            else
                FRONT = FRONT + 1;
    ...
    void display() {
        ...
        // jika FRONT_position <= REAR_posistion, iterasi dari FRONT hingga REAR
...
int main() {
    ...
    while (true) {
        try {
            cout << "Menu " << endl;
            cout << "1. Imlement insert operation" << endl;
            cout << "2. Implement dalete operation" << endl;
